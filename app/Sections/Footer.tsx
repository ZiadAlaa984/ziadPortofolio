    ...
    <section className=" bg-black w-full  border-t border-stone-900 footer  md:mt-0 p-5 md:p-8 ">
      <div className="flex mx-auto flex-col   justify-start   gap-4  items-center w-full">
        ...
        <ul className="flex flex-row justify-between items-center space-x-4 md:space-x-6">
          <FramerMagnetic>
            <li
              className="md:p-5 p-3 rounded-full cursor-pointer text-white text-xl border shadow-stone-900 border-stone-900"
              draggable="false"
          ...
          <FramerMagnetic>
            <li
              ...
              style={{ userSelect: "none", touchAction: "none" }}
            >
              <a target="_blank" href="https://wa.me/+201225747823">
                <svg
                  fill="currentColor"
                  width={24}
                  height={24}
          ...
          <FramerMagnetic>
            <li
              ...
              style={{ userSelect: "none", touchAction: "none" }}
            >
              <a target="_blank" href="mailto:ziadalaa984@gmail.com">
                <svg
                  fill="currentColor"
                  width={24}
                  height={24}
          ...
          <FramerMagnetic>
            <li
              ...
              style={{ userSelect: "none", touchAction: "none" }}
            >
              <a target="_blank" href="https://github.com/ZiadAlaa984">
                <svg
                  fill="currentColor"
                  width={24}
                  height={24}
